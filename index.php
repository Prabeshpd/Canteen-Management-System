...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="stafflogin.php">Canteen Staff Login <span class="sr-only">(current)</span></a>
            </li>
    </div>
    <div id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="employeelogin.php">Employee Login To Order Foood <span class="sr-only">(current)</span></a>
            </li>
    </div>
</nav>
